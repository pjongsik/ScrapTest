...
namespace IntetparkScrapTest
{
    public partial class SongJiHoForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //
            webBrowser1.Navigate("http://125.209.198.55/reservation/online_step_01.php");
        ...
        private void InitControl()
        {
            ...
            for (int count = 1; count < 31; count++)
                cbDay.Items.Add(count);

            cbDay.SelectedItem = DateTime.Now.Day;

            cbSleepDay.SelectedItem = "2";
            cbSite.SelectedItem = "통나무집";
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //object obj = doc.InvokeScript("fnPlayDateChange", new string[] { "2", "20170429" });
